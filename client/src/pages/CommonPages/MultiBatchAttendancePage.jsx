    ...
    const renderSummary = () => {
        ...
        return (
             <div className="w-full max-w-2xl mx-auto bg-white rounded-[2.5rem] sm:rounded-[3rem] shadow-2xl overflow-hidden animate-fade-in text-center p-4 sm:p-6 m-4 max-h-[90vh] overflow-y-auto custom-scrollbar border border-slate-100">
                ...
                <button onClick={handleExitSession} className="w-full bg-slate-900 text-white py-5 rounded-2xl font-bold text-lg hover:bg-black transition-all shadow-xl shadow-slate-200 active:scale-95">Return to Dashboard</button>
             </div>
        );
    };
