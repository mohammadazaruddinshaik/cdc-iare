...
export default function MultiBatchAttendancePage() {
    ...
    // FIX ADDED: Processing lock for scanner
    ...
    const handleScan = useCallback((text) => {
        ...
        try {
            ...
            // Strictly check for required fields based on your data structure
        ...
        // 5. VALIDATION LOGIC
        if (roll) {
            // Check if already scanned (Note: scannedData is a Map here)
            ...
            // Check if student belongs to loaded batches
                ...
                // Start cooldown (useEffect handles unlock)
                setCooldown(3); 
            } 
            // Valid QR but student not in selected batches
            else {
