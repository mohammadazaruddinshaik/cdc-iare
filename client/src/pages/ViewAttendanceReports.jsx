          ...
          <div className="w-full max-w-md bg-slate-800 rounded-2xl p-6 sm:p-8 shadow-2xl border border-white/10">
            ...
            <div className="space-y-6">
              ...
              <div className="relative" ref={dropdownRef}>
                <label className={`absolute left-4 transition-all duration-300 pointer-events-none ${selectedBatch ? 'text-xs -top-2 bg-slate-800 px-1 text-slate-300' : 'top-3.5 text-slate-400'}`}>
                  Batch
                </label>
                <button
                  onClick={() => setIsDropdownOpen(!isDropdownOpen)}
                  className="relative w-full px-4 py-3 bg-white/5 border border-white/10 rounded-lg shadow-sm cursor-pointer flex items-center justify-between focus:outline-none focus:ring-2 focus:ring-sky-500"
                >
              ...
              <div className="relative">
                <label htmlFor="report-date" className="absolute left-4 text-xs -top-2 bg-slate-800 px-1 text-slate-300">
                  Date
                </label>
                <input
                  id="report-date"
