...
//     return (
//         <div className="fixed inset-0 bg-gray-900/60 backdrop-blur-sm flex items-center justify-center z-50 p-4 transition-all duration-300" onClick={onClose}>
...
//                                     {/* UPDATED BUTTON: White Background, Black Text */}
//                                     <button 
...
const ChangePasswordModal = ({ isOpen, onClose, username }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // PATCH REQUEST: Encrypt Request, Decrypt Response
            ...
            // Decrypt the response from PATCH
...
const FacultyProfilePage = () => {
    ...
    useEffect(() => {
        ...
        const fetchProfileData = async () => {
            try {
                // GET REQUEST: STANDARD JSON - NO ENCRYPTION/DECRYPTION
                const response = await fetch(`${backendUrl}/api/faculty/get-profile-data`, {
                    method: 'GET',
                    headers: { 'Content-Type': 'application/json' },
                    credentials: "include",
