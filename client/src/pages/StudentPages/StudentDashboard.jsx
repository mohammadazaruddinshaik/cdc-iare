...
// import { Trophy, CalendarOff, BookOpen, Terminal, Database, Cpu, Network, Globe, Lock, Clock, MapPin } from 'lucide-react';
...
// // Metadata for "Known" Courses
// const knownCourses = {
//     'CP': { 
//         title: "Competitive Programming", 
//         icon: <Terminal className="w-5 h-5 text-blue-700" />,
//         theme: { bg: "bg-gradient-to-br from-blue-100 via-blue-50 to-purple-50", progress: "bg-gradient-to-r from-blue-600 to-purple-600" }
//     },
//     'DBMS': { 
//         title: "Database Mgmt Systems", 
//         icon: <Database className="w-5 h-5 text-emerald-700" />,
//         theme: { bg: "bg-gradient-to-br from-emerald-100 via-emerald-50 to-teal-50", progress: "bg-gradient-to-r from-emerald-600 to-teal-600" }
//     },
//     'CSM601': {
//         title: "Machine Learning",
//         icon: <Cpu className="w-5 h-5 text-orange-700" />,
//         theme: { bg: "bg-gradient-to-br from-orange-100 via-orange-50 to-red-50", progress: "bg-gradient-to-r from-orange-600 to-red-600" }
//     },
//     'CSM602': {
//         title: "Computer Networks",
//         icon: <Network className="w-5 h-5 text-cyan-700" />,
//         theme: { bg: "bg-gradient-to-br from-cyan-100 via-cyan-50 to-blue-50", progress: "bg-gradient-to-r from-cyan-600 to-blue-600" }
//     },
//     'CSM603': {
//         title: "AI & Soft Computing",
//         icon: <Cpu className="w-5 h-5 text-purple-700" />,
//         theme: { bg: "bg-gradient-to-br from-purple-100 via-purple-50 to-fuchsia-50", progress: "bg-gradient-to-r from-purple-600 to-fuchsia-600" }
//     },
//     'CSM604': {
//         title: "Cryptography",
//         icon: <Lock className="w-5 h-5 text-slate-700" />,
//         theme: { bg: "bg-gradient-to-br from-slate-200 via-slate-100 to-gray-100", progress: "bg-gradient-to-r from-slate-600 to-gray-600" }
//     },
//     'CSM605': {
//         title: "Web Technologies",
//         icon: <Globe className="w-5 h-5 text-indigo-700" />,
//         theme: { bg: "bg-gradient-to-br from-indigo-100 via-indigo-50 to-violet-50", progress: "bg-gradient-to-r from-indigo-600 to-violet-600" }
//     }
// };
...
//         return knownCourses[safeCode];
//     }
//     const partialKey = Object.keys(knownCourses).find(key => safeCode.startsWith(key));
//     if (partialKey) {
//         return knownCourses[partialKey];
//     }
...
//                         <div className={`w-full md:w-3/4 bg-gradient-to-br from-slate-900/80 to-slate-800/80 backdrop-blur-xl text-white rounded-2xl sm:rounded-3xl p-6 shadow-2xl border border-white/10 relative overflow-hidden transform transition-all duration-1000 delay-300 flex flex-col justify-center ${animate ? 'translate-y-0 opacity-100' : 'translate-y-5 opacity-0'}`}>
//                             {/* Decorative Glow */}
//                             <div className="absolute top-0 right-0 -mr-16 -mt-16 w-32 h-32 bg-blue-500/20 blur-3xl rounded-full pointer-events-none"></div>
                            
//                             <h2 className="text-lg sm:text-xl font-bold mb-4 bg-gradient-to-r from-blue-100 to-indigo-200 bg-clip-text text-transparent flex items-center gap-2">
...
//                                         return (
//                                             <div key={index} className="flex items-center justify-between bg-white/5 hover:bg-white/10 transition-colors p-4 rounded-xl border-l-4 border-blue-500 shadow-sm relative overflow-hidden group">
//                                                 <div className="flex items-center space-x-3 relative z-10">
//                                                     <div>
//                                                         <p className="font-bold text-sm sm:text-base text-white group-hover:text-blue-200 transition-colors">{session.subject}</p>
//                                                         <p className="text-xs text-gray-400 flex items-center gap-1"><MapPin size={10}/> Room: {session.roomNo}</p>
//                                                     </div>
//                                                 </div>
//                                                 <div className="text-right relative z-10">
//                                                     <p className="font-bold text-sm sm:text-base text-white tracking-wide">{displayTime}</p>
...
//                                 </div>
//                             ) : (
//                                 <div className="flex flex-col items-center justify-center bg-white/5 p-6 rounded-xl border border-dashed border-white/20">
//                                     <CalendarOff className="w-8 h-8 mb-2 text-gray-400" />
//                                     <p className="font-semibold text-sm sm:text-base text-gray-300">No classes scheduled for today!</p>
//                                 </div>
//                             )}
//                         </div>

//                         {/* --- ENHANCED ATTENDANCE SECTION --- */}
//                         <div className={`w-full md:w-1/4 bg-gradient-to-br from-[#1e1b4b]/60 to-[#0f172a]/60 backdrop-blur-xl text-white rounded-2xl sm:rounded-3xl p-6 shadow-2xl border border-indigo-500/20 relative overflow-hidden transform transition-all duration-1000 delay-400 h-full flex flex-col items-center justify-center min-h-[250px] ${animate ? 'translate-y-0 opacity-100' : 'translate-y-5 opacity-0'}`}>
//                              {/* Decorative Glows */}
...
//                             <h2 className="text-base sm:text-lg font-bold text-white mb-2 relative z-10">Overall Attendance</h2>
                            
//                             <div className="relative z-10 mt-2 p-2 bg-indigo-950/30 rounded-full shadow-inner border border-white/5">
//                                 <DonutChart 
...
//                                 />
//                             </div>
//                             <p className="text-xs text-indigo-200/60 mt-4 text-center">Calculated from total enrolled courses</p>
//                         </div>
//                     </div>
...
//                             </div>
//                         ) : (
//                             <div className="w-full bg-white/10 backdrop-blur-lg rounded-2xl p-8 text-center border border-white/10">
//                                 <BookOpen className="w-12 h-12 text-white/50 mx-auto mb-3" />
//                                 <p className="text-white text-lg font-medium">No courses enrolled yet.</p>
//                             </div>
//                         )}
//                     </div>
//                 </div>
...
//                                 )) : (
//                                     <div className="col-span-3 text-center text-gray-500 py-12 flex flex-col items-center justify-center">
            ...
            <div className="bg-gradient-to-br from-[#071225] via-[#0A1B3A] to-[#071225] w-full rounded-bl-[2rem] rounded-br-[2rem] sm:rounded-bl-[3rem] sm:rounded-br-[3rem] relative overflow-hidden pb-8">
                ...
                <div className="px-4 sm:px-6 lg:px-8 relative z-50">
                    ...
                    <div className="flex flex-col md:flex-row gap-6 lg:gap-8 relative z-10 mt-6 items-stretch">
                        ...
                        {/* --- TIMETABLE SECTION --- */}
                        {/* UPDATES: Added justify-center for vertical center, added faculty logic */}
