                    ...
                    <div className="relative z-10 w-full max-w-xl flex flex-col items-center justify-center h-full">
                        <div className="mb-8 text-center">
                            <h1 className="text-3xl xl:text-4xl font-extrabold mb-2 leading-tight">
                              <span className="text-white">Where</span> <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-400">Precision</span> <span className="text-white">Meets</span> <span className="bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-pink-400">Performance.</span>
                            </h1>
                        ...
                        <div className="w-full max-w-xs sm:max-w-sm relative z-10">
                            ...
                            <form onSubmit={handleLogin} className="space-y-4">
                                ...
                                <div className="flex justify-end px-1">
                                    <button type="button" onClick={() => setShowForgotModal(true)} className="text-xs font-bold text-blue-600 hover:text-purple-600 transition-colors">Forgot password?</button>
                                </div>

                                <motion.button whileHover={{ scale: 1.01, boxShadow: "0 10px 25px -5px rgba(59, 130, 246, 0.4)" }} whileTap={{ scale: 0.98 }} type="submit" disabled={isLoading} className="w-full bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-700 text-white text-base font-bold py-3 rounded-full shadow-xl transition-all disabled:opacity-50 flex items-center justify-center gap-2">
            ...
            <div id="meet-team" className="w-full bg-[#F8FAFC] py-16 px-6 border-t border-gray-200 flex items-center justify-center min-h-auto lg:min-h-[80vh]">
                <div className="max-w-7xl w-full"> 
                    <div className="text-center mb-10">
                        ...
                        <div className="h-1.5 w-20 bg-gradient-to-r from-blue-500 to-purple-600 mx-auto rounded-full mt-3"></div>
                    </div>
