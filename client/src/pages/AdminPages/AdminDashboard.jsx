...
const AdminDashboardPage = () => {
    ...
    const managementItems = [
        ...
        { title: "Debugging", icon: <Bug className="w-6 h-6 lg:w-7 lg:h-7 text-slate-600" />, description: "Run Data-Integrity & Maintenance Checks", bgColor: "bg-gradient-to-br from-slate-200 via-slate-100 to-gray-100", path: "/admin/debugging" },
    ];
